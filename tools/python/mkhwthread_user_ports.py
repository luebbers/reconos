...
def exitUsage():
    sys.stderr.write("Usage: %s user_logic_entity thread_num user_port_decl_file [ vhdl_files... ] [-v netlist1 -v netlist2 ...]\n" % os.path.basename(sys.argv[0]))
...
def main(args):
    ...
    reconos.pcore_user_ports.createPCore(user_logic_name,task_number,user_port_decl, vhdl_files,task_name,[os.environ["RECONOS"] + "/support/templates/coregen/burst_ram/burst_ram.edn"] + netlist_files,header)
