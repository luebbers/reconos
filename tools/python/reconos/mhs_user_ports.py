...
def createReconosTask(num_slot, num_task, task_name = "hw_task", task_clk = None, osif_clk = None, connect = True):
        ...
        if osif_clk:
          ...
          #SGMII ports (very dirty)
        if num_slot == 2:
		pcore.addEntry("PORT", "TXP", "TXP")
		pcore.addEntry("PORT", "TXN", "TXN")
		pcore.addEntry("PORT", "RXP", "RXP")
		pcore.addEntry("PORT", "RXN", "RXN")
		pcore.addEntry("PORT", "MGTCLK_P", "MGTCLK_P")
		pcore.addEntry("PORT", "MGTCLK_N", "MGTCLK_N")
		pcore.addEntry("PORT", "PRE_PHY_RESET", "sys_rst_s")
		pcore.addEntry("PORT", "PHY_RESET", "PHY_RESET")
        pcore.addEntry("PORT", "data_"+str(num_slot), "data_"+str(num_slot))
        pcore.addEntry("PORT", "busdata_"+str(num_slot), "busdata_"+str(num_slot))
        pcore.addEntry("PORT", "req_"+str(num_slot), "req_"+str(num_slot))
        pcore.addEntry("PORT", "ready_"+str(num_slot), "ready_"+str(num_slot))
        pcore.addEntry("PORT", "grant_"+str(num_slot), "grant_"+str(num_slot))
        pcore.addEntry("PORT", "sof_"+str(num_slot), "sof_"+str(num_slot))
        pcore.addEntry("PORT", "eof_"+str(num_slot), "eof_"+str(num_slot))
	pcore.addEntry("PORT", "src_rdy_"+str(num_slot), "src_rdy_"+str(num_slot))
        pcore.addEntry("PORT", "dst_rdy_"+str(num_slot), "dst_rdy_"+str(num_slot))
        pcore.addEntry("PORT", "bussof_"+str(num_slot), "bussof_"+str(num_slot))
        pcore.addEntry("PORT", "buseof_"+str(num_slot), "buseof_"+str(num_slot))
	pcore.addEntry("PORT", "bus_dst_rdy_"+str(num_slot), "bus_dst_rdy_"+str(num_slot))
        pcore.addEntry("PORT", "bus_src_rdy_"+str(num_slot), "bus_src_rdy_"+str(num_slot))
