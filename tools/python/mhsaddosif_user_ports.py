...
if __name__ == "__main__":
    ...
    # parse mhs file
    a = reconos.mhs_user_ports.MHS(mhs_orig)
    ...
    for s in range(current_slots, current_slots + num_slots):
        pcore = reconos.mhs_user_ports.createReconosSlot(s, plb_name, dcr_name, clock, reset, osif_pcore_name, plb_ver = plb_ver)
