...
#
#  File     plb_bus_list.do (Thu Feb 15 13:04:30 2007)
#
...
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_compress
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_guarded
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_lockErr
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_MSize
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_ordered
...
# eval add list $hexopt $tbpath${ps}plb_bus${ps}Sl_MErr
...
# eval add list $hexopt $tbpath${ps}plb_bus${ps}Sl_wrDAck
  ...
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MErr
  ...
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_SMErr
