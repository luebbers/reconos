...
#
#  File     plb_bus_wave.do (Thu Feb 15 13:04:30 2007)
#
...
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}M_compress
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}M_guarded
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}M_lockErr
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}M_MSize
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}M_ordered
...
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}Sl_addrAck
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}Sl_MErr
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}Sl_MBusy
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}Sl_rdBTerm
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}Sl_rdComp
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}Sl_rdDAck
...
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}Sl_rearbitrate
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}Sl_SSize
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}Sl_wait
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}Sl_wrBTerm
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}Sl_wrComp
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}Sl_wrDAck
  ...
  eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}PLB_MErr
  ...
  eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}PLB_SMErr
...
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}PLB2OPB_rearb
