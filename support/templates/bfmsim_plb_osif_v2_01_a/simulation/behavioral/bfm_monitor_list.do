...
#
#  File     bfm_monitor_list.do (Thu Feb 15 13:04:30 2007)
#
...
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}M_compress
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}M_guarded
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}M_ordered
...
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}PLB_MErr
...
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}Sl_addrAck
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}Sl_wait
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}Sl_rearbitrate
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}Sl_wrDAck
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}Sl_wrComp
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}Sl_wrBTerm
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}Sl_rdDBus
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}Sl_rdWdAddr
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}Sl_rdDAck
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}Sl_rdComp
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}Sl_rdBTerm
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}Sl_MBusy
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}Sl_MErr
...
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}PLB_SMErr
