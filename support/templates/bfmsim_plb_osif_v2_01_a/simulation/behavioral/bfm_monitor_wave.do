...
#
#  File     bfm_monitor_wave.do (Thu Feb 15 13:04:30 2007)
#
...
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}M_compress
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}M_guarded
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}M_ordered
...
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}PLB_MErr
...
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}Sl_addrAck
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}Sl_wait
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}Sl_rearbitrate
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}Sl_wrDAck
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}Sl_wrComp
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}Sl_wrBTerm
...
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}Sl_rdDAck
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}Sl_rdComp
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}Sl_rdBTerm
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}Sl_MBusy
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}Sl_MErr
...
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}PLB_SMErr
