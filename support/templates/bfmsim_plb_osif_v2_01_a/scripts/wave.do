...
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/slv_IP2Bus_RdAck
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/slv_IP2Bus_WrAck
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/burst_IP2Bus_RdAck
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/burst_IP2Bus_WrAck
...
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/burst_ram_i/clka
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/burst_ram_i/wea 
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/burst_ram_i/ena
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/burst_ram_i/addra 
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/burst_ram_i/dina
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/burst_ram_i/douta 
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/burst_ram_i/clkax 
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/burst_ram_i/weax
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/burst_ram_i/enax
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/burst_ram_i/addrax
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/burst_ram_i/dinax 
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/burst_ram_i/doutax
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/burst_ram_i/clkb
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/burst_ram_i/web
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/burst_ram_i/enb
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/burst_ram_i/beb 
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/burst_ram_i/addrb 
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/burst_ram_i/dinb 
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/burst_ram_i/doutb 
