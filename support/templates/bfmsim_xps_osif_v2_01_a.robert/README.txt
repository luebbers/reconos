...
------------------------------------------------------------------------------
1. Open any command/shell window, e.g. DOS or cygwin, and go to this
   bfmsim directory.

2. Open the bfm_sim_cmd.make file, e.g. in DOS edit or cygwin vi, to edit
...
3. Click Simulation -> Generate Simulation HDL Files in XPS to generate the BFM
   simulation platform.
