...
#
#  File     plb_bus_list.do (Fri Jul 24 13:41:05 2009)
#
...
# eval add list $binopt $tbpath${ps}plb_bus${ps}SPLB_Rst
  eval add list $hexopt $tbpath${ps}plb_bus${ps}MPLB_Rst
...
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_RNW
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_abort
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_busLock
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_TAttribute
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_lockErr
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_MSize
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_priority
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_rdBurst
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_request
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_size
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_type
# eval add list $hexopt $tbpath${ps}plb_bus${ps}M_wrBurst
...
# eval add list $hexopt $tbpath${ps}plb_bus${ps}Sl_MIRQ
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MIRQ
  ...
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MAddrAck
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MTimeout
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MBusy
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MRdErr
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MWrErr
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MRdBTerm
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MRdDAck
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MRdDBus
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MRdWdAddr
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MRearbitrate
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MWrBTerm
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_MWrDAck
  ...
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_SMRdErr
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_SMWrErr
  eval add list $hexopt $tbpath${ps}plb_bus${ps}PLB_SMBusy
