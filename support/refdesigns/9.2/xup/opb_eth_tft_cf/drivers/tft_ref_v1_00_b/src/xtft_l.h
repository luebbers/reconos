...
void XTft_FillScreen(void * BaseAddress, Xuint32 xu, Xuint32 yu, 
                     Xuint32 xl, Xuint32 yl, Xuint32 color);

void XTft_WriteChar(void * BaseAddress, Xint8 ch, Xuint32 xu, Xuint32 yu,
