/* $Id: xbuf_descriptor.h,v 1.13 2006/06/02 21:43:44 meinelte Exp $ */
/******************************************************************************
*
...
typedef Xuint32 XBufDescriptor[XBD_SIZE_IN_WORDS];
...
{                                                               \
    (*((Xuint32 *)InstancePtr + XBD_CONTROL_OFFSET) = 0);       \
    (*((Xuint32 *)InstancePtr + XBD_SOURCE_OFFSET) = 0);        \
    (*((Xuint32 *)InstancePtr + XBD_DESTINATION_OFFSET) = 0);   \
    (*((Xuint32 *)InstancePtr + XBD_LENGTH_OFFSET) = 0);        \
    (*((Xuint32 *)InstancePtr + XBD_STATUS_OFFSET) = 0);        \
    (*((Xuint32 *)InstancePtr + XBD_DEVICE_STATUS_OFFSET) = 0); \
    (*((Xuint32 *)InstancePtr + XBD_NEXT_PTR_OFFSET) = 0);      \
    (*((Xuint32 *)InstancePtr + XBD_ID_OFFSET) = 0);            \
    (*((Xuint32 *)InstancePtr + XBD_FLAGS_OFFSET) = 0);         \
    (*((Xuint32 *)InstancePtr + XBD_RQSTED_LENGTH_OFFSET) = 0); \
}
...
#define XBufDescriptor_GetControl(InstancePtr)   \
    (Xuint32)(*((Xuint32 *)InstancePtr + XBD_CONTROL_OFFSET))
...
#define XBufDescriptor_SetControl(InstancePtr, Control)  \
    (*((Xuint32 *)InstancePtr + XBD_CONTROL_OFFSET) = (Xuint32)Control)
...
* @return
*
* XTRUE if the buffer descriptor is marked as last in the control field,
* otherwise, XFALSE.
*
* @note
*
...
#define XBufDescriptor_IsLastControl(InstancePtr) \
    (Xboolean)((*((Xuint32 *)InstancePtr + XBD_CONTROL_OFFSET) & \
...
#define XBufDescriptor_SetLast(InstancePtr) \
    (*((Xuint32 *)InstancePtr + XBD_CONTROL_OFFSET) |= XDC_CONTROL_LAST_BD_MASK)
...
#define XBufDescriptor_GetSrcAddress(InstancePtr) \
    ((Xuint32 *)(*((Xuint32 *)InstancePtr + XBD_SOURCE_OFFSET)))
...
#define XBufDescriptor_SetSrcAddress(InstancePtr, Source) \
    (*((Xuint32 *)InstancePtr + XBD_SOURCE_OFFSET) = (Xuint32)Source)
...
#define XBufDescriptor_GetDestAddress(InstancePtr) \
    ((Xuint32 *)(*((Xuint32 *)InstancePtr + XBD_DESTINATION_OFFSET)))
...
#define XBufDescriptor_SetDestAddress(InstancePtr, Destination) \
    (*((Xuint32 *)InstancePtr + XBD_DESTINATION_OFFSET) = (Xuint32)Destination)
...
#define XBufDescriptor_GetLength(InstancePtr)                           \
    (Xuint32)(*((Xuint32 *)InstancePtr + XBD_RQSTED_LENGTH_OFFSET) -    \
...
{                                                                           \
    (*((Xuint32 *)InstancePtr + XBD_LENGTH_OFFSET) = (Xuint32)(Length));    \
    (*((Xuint32 *)InstancePtr + XBD_RQSTED_LENGTH_OFFSET) = (Xuint32)(Length));\
}
...
#define XBufDescriptor_GetStatus(InstancePtr)    \
    (Xuint32)(*((Xuint32 *)InstancePtr + XBD_STATUS_OFFSET))
...
#define XBufDescriptor_SetStatus(InstancePtr, Status)    \
    (*((Xuint32 *)InstancePtr + XBD_STATUS_OFFSET) = (Xuint32)Status)
...
* @return
*
* XTRUE if the buffer descriptor is marked as last in the status field,
* otherwise, XFALSE.
*
* @note
*
...
#define XBufDescriptor_IsLastStatus(InstancePtr) \
    (Xboolean)((*((Xuint32 *)InstancePtr + XBD_STATUS_OFFSET) & \
...
#define XBufDescriptor_GetDeviceStatus(InstancePtr) \
    ((Xuint32)(*((Xuint32 *)InstancePtr + XBD_DEVICE_STATUS_OFFSET)))
...
#define XBufDescriptor_GetNextPtr(InstancePtr) \
    (XBufDescriptor *)(*((Xuint32 *)InstancePtr + XBD_NEXT_PTR_OFFSET))
...
#define XBufDescriptor_SetNextPtr(InstancePtr, NextPtr) \
    (*((Xuint32 *)InstancePtr + XBD_NEXT_PTR_OFFSET) = (Xuint32)NextPtr)
...
#define XBufDescriptor_GetId(InstancePtr) \
    (Xuint32)(*((Xuint32 *)InstancePtr + XBD_ID_OFFSET))
...
#define XBufDescriptor_SetId(InstancePtr, Id) \
    (*((Xuint32 *)InstancePtr + XBD_ID_OFFSET) = (Xuint32)Id)
