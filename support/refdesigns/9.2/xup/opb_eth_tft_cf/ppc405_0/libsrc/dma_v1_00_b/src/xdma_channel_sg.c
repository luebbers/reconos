/* $Id: xdma_channel_sg.c,v 1.3 2006/07/24 17:50:20 xduan Exp $ */
/******************************************************************************
*
...
* @return
*
* A value of XTRUE if the scatter gather list is empty, otherwise a value of
* XFALSE.
*
* @note
*
                                  ...
                                  XBufDescriptor *BufferDescriptorPtr)
{
    ...
    XASSERT_NONVOID(((Xuint32)BufferDescriptorPtr & 3) == 0);
    XASSERT_NONVOID(InstancePtr->IsReady == XCOMPONENT_IS_READY);
     ...
     */
    if (InstancePtr->ActiveDescriptorCount == InstancePtr->TotalDescriptorCount)
    {
     ...
     */
    if (InstancePtr->CommitPtr == XNULL)
    {
...
void XDmaChannel_DecrementPktCount(XDmaChannel *InstancePtr)
{
    ...
    if (Register > 0)
    {
        XIo_Out32(InstancePtr->RegBaseAddress + XDC_UPC_REG_OFFSET, 1UL);
    }
}
...
Xuint8 XDmaChannel_GetPktThreshold(XDmaChannel *InstancePtr)
{
    ...
    return (Xuint8)XIo_In32(InstancePtr->RegBaseAddress + XDC_PCT_REG_OFFSET);
}
