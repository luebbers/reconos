...
<xsl:variable name="BLKD_BIF_GAP_H" select="ceiling($BLKD_BIF_H div 4)"/>				
<xsl:variable name="BLKD_BIF_GAP_V" select="ceiling($BLKD_BIFC_H div 2)"/>				
...
<xsl:variable name="BLKD_BUS_LANE_W"    select="($BLKD_BIF_W + ($BLKD_BIF_GAP_H * 2))"/>
...
<xsl:variable name="BLKD_MOD_W"  select="(                    ($BLKD_BIF_W * 2) + ($BLKD_BIF_GAP_H * 1) + ($BLKD_MOD_LANE_W * 2))"/>
<xsl:variable name="BLKD_MOD_H"  select="($BLKD_MOD_LABEL_H + ($BLKD_BIF_H * 1) + ($BLKD_BIF_GAP_V * 1) + ($BLKD_MOD_LANE_H * 2))"/>
	
	
<xsl:variable name="BLKD_MOD_LABEL_W"   select="(($BLKD_BIF_W * 2) + $BLKD_BIF_GAP_H)"/>
...
<xsl:variable name="BLKD_MPMC_MOD_H"    select="(($BLKD_BIF_H * 1) + ($BLKD_BIF_GAP_V * 2) + ($BLKD_MOD_LANE_H * 2))"/>
