...
add wave -noupdate -format Literal -radix hexadecimal -expand /bfm_system/my_core/my_core/uut/user_logic_i/osif_os2task
add wave -noupdate -format Literal -radix hexadecimal -expand /bfm_system/my_core/my_core/uut/user_logic_i/osif_task2os
...
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/task_0_inst/result
...
update
WaveRestoreZoom {0 ps} {3883077 ps}
