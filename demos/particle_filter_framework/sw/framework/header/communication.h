...
#define TRUE  1
//! defines block size (maximum 2000 particles per block)
//#define SIZE 10
...
//! message boxes to stop a hw thread
cyg_mbox *hw_mb_sampling_exit,
         *hw_mb_observation_exit,
         *hw_mb_importance_exit,
         *hw_mb_resampling_exit; 

//! handles for message boxes to stop a hw thread
cyg_handle_t *hw_mb_sampling_exit_handle,
             *hw_mb_observation_exit_handle,
             *hw_mb_importance_exit_handle,
             *hw_mb_resampling_exit_handle; 
...
/**
  creates sw thread for importance switch. This thread gets first the observations of the needed particles
  and puts Messages into sw or hw message boxes. 
*/
void create_preImportance_thread(void);
